...
program	: tBEGIN list tEND { compiler->ast(new simple::program_node(LINE, $2)); }
	      ;
...
expr : tINTEGER                { $$ = new cdk::integer_node(LINE, $1); }
     ...
     | '(' expr ')'            { $$ = $2; }
     | lval                    { $$ = new simple::rvalue_node(LINE, $1); }  //FIXME
     | lval '=' expr           { $$ = new simple::assignment_node(LINE, $1, $3); }
     ;

lval : tIDENTIFIER             { $$ = new simple::lvalue_node(LINE, $1); }
     ;
